...
<ul class="info">
    ...
    <li class="info"><a href="<?=url::base() . Request::current()->controller?>">Voltar para a listagem de
        entidades.</a>
    </li>
</ul>
<?php endif ?>
...
<fieldset title="Dados Obrigatórios">
    ...
    <span id="destAndroid">
        		<input type="radio" name="isAndroid" id="radioDestAndroid" tabindex="0" value="1" checked="checked"
                       style="margin: 0"/>
        		<label for="radioDestAndroid"><img src="<?=url::base()?>images/android16.png" alt=""
                                                   style="vertical-align: -3px"> Android</label>
    </span>&nbsp;&nbsp;&nbsp;&nbsp;
    <span id="destLinux">
        <input type="radio" name="isAndroid" tabindex="0" id="radioDestLinux" value="0" style="margin: 0">
    ...
    <span id="ipCheck" class="input info">A verificação do agente Android não é automática, verifique se o nome está correto antes de prosseguir.</span><br/>
    <?=$entity->label('city');?>
...
<script type="text/javascript">
    $(function () {
        ...
        $('input[name$="ipaddress"]').blur(function () {
            if (!$('#radioDestAndroid').is(':checked')) {
                checkIp();
            } else {
        ...
        $('#radioDestAndroid').click(function (evt) {
            enableFields();
            $('span#ipCheck').remove();
        ...
        $('#radioDestLinux').click(function (evt) {
            $('span#ipCheck').remove();
            $('input[name$="ipaddress"]').after('<span id="ipCheck" class="input info">Endereços válidos: número IPv4 (123.123.123.123) ou hostname netmetric (5188888888.vivo.com.br)</span>');
            disableFields();
        ...
        function disableFields() {
            ...
            $('#radioDestLinux')[0].disabled = false;
            $('#radioDestAndroid')[0].disabled = false;
        }
