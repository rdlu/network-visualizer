	...
	$.extend({
		progressBar: new function() {
			...
			this.defaults = {
				...
				width			: 30,											// Width of the progressbar - don't forget to adjust your image too!!!												// Image to use in the progressbar. Can be a single image too: 'images/progressbg_green.gif'
				height			: 4,											// Height of the progressbar - don't forget to adjust your image too!!!
				callback		: null,											// Calls back with the config object that has the current percentage, target percentage, current image, etc
				boxImage		: 'images/bar/progressbar.gif',						// boxImage : image around the progress bar
				barImage		: {
									0:  'images/bar/progressbg_red.gif',
									30: 'images/bar/progressbg_orange.gif',
									70: 'images/bar/progressbg_green.gif'
								},
