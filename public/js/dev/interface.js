...
var Template = {
    ...
    sondaDestaque:function (id, ip, nome, status, opcoes, localidade) {
        //alert(id);
        ...
        template.find('#sondaOpcoes').html(opcoes);
    ...
    mostraDestaque:function (id) {
        ...
        $.ajax({
            ...
            success:function (dados) {
                opcoes = '<a href="/mom/entities/view/' + id + '">Mais informações...</a>';
        ...
        Template.sondaDestaque(id, ip, nome, status, opcoes, localidade);
    },
